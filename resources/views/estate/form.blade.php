        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('name', $estate->name, ['class' => 'form-control' . ($errors->has('name') ? ' is-invalid' : ''), 'placeholder' => 'Ingrese un nombre']) }}
                ...
                <div class="form-group">
                    ...
                    {{-- @php
                        ...
                        if (!empty($user->clients)) {
                            ...
                            // Obtener los valores de 'cliente_id' para el atributo 'value' del select
                            // $selectedClients = array_column($selectedClients, 'cliente_id');
                        }
                    @endphp --}}
                    {{ Form::select('cliente_id', $clients, $estate->cliente_id, ['class' => 'form-control select2' . ($errors->has('cliente_id') ? ' is-invalid' : ''), 'id' => 'cliente_id', 'placeholder' => 'Seleccione el cliente']) }}
        ...
        <div class="row">
            <div class="col-12 col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::textArea('observations', $estate->observations, ['class' => 'form-control' . ($errors->has('observations') ? ' is-invalid' : ''), 'placeholder' => 'Observaciones']) }}
