...
@section('js')
    <script>
        window.addEventListener('show-modal', event => {
            ...
            $('#id_cliente').val(operation.id_cliente);
            $('#pilot_id').val(operation.pilot_id);
            $('#assistant_id_one').val(operation.assistant_id_one);
            $('#assistant_id_two').val(operation.assistant_id_two);
            $('#evidence_record').val(operation.evidence_record);
            $('#evidence_aplication').val(operation.evidence_aplication);
            $('#dron_id').val(operation.dron_id);
            $('#download').val(operation.download);
            $('#zone_id').val(operation.zone_id);
            $('#number_flights').val(operation.number_flights);
            $('#hour_flights').val(operation.hour_flights);
            $('#observation_admin').val(operation.observation_admin);
        })
