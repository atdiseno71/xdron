                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('lucks.destroy',$luck->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('lucks.show',$luck->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('lucks.edit',$luck->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
